...
private:
    ...
    {
        //Modifiez les valeurs dans les matrices pour améliorer la correction du filtre
        //Modifiez plus les paramètres de la diagonale de la matrice pour voir des changements plus flagrant
