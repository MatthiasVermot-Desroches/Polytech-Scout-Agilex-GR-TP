...
class BehaviorManager(Node):
    ...
    def __init__(self):
        ...
        self.distance_Z = 10.0  # Initialisée grand par sécurité
        self.previous_state = None
        self.pieton_on_psg = False
        self.dist_pieton = None
        self.stop_start_time = None

        # Commandes de base du suiveur de ligne
    ...
    def control_loop(self):
        ...
        # Différent coefficients pour ralentir le robot (notamment pour le STOP et le feu rouge)
