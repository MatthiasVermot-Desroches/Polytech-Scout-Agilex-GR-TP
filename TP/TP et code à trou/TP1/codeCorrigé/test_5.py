...
class RobotSuiveurPD(Node):
    ...
    def boucle(self):
        ...
        if self.dist_devant_centre < self.dist_stop:
            ...
            erreur_totale = erreur_suivi + erreur_anticipation
        ...
        derivee_angulaire = (erreur_totale - self.erreur_ang_precedente) / dt
        self.erreur_ang_precedente = erreur_totale
        cmd_z = (self.kp_ang * erreur_totale) + (self.kd_ang * derivee_angulaire)
