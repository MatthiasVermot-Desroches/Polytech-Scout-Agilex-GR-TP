...
docker run \
    ...
    -v $HOME/ros2-libs/pip-cache:/home/$USER/.cache/pip \
    -v $HOME/ros2-libs/apt-cache:/var/cache/apt/archives \
    -v $HOME/ros2-libs/pythonpackages:/home/$USER/.local/lib/python3.10/site-packages \
