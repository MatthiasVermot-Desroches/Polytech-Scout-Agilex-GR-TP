...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('topic_queue_size', default_value='50',               description='Queue size of individual topic subscribers.'),
        ...
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/rslidar_points', description=''),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/imu/disabled', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
