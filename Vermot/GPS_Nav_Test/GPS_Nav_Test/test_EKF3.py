...
class GPSNavigationEKF(Node):
    ...
    # ==========================================================
    # BEARING (Géographique : 0 = Nord, horaire)
    # ==========================================================
    ...
    def control_loop(self):
        ...
        # 1. Calcul du cap géographique issu des coordonnées GPS (0 = Nord, Horaire)
        bearing_geo = self.compute_bearing()

        # 2. 🔥 CORRECTION REPERE : Conversion vers la norme ROS ENU (0 = Est, Anti-horaire)
        bearing_ros_enu = (math.pi / 2.0) - bearing_geo

        # 3. Calcul de l'erreur angulaire dans le même repère (ROS ENU)
        ...
        # Logs détaillés pour aider vos étudiants à visualiser la correction de repère
        self.get_logger().info(
