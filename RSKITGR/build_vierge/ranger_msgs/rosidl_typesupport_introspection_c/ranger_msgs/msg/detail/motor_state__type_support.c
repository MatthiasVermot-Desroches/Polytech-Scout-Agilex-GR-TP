...
static rosidl_typesupport_introspection_c__MessageMember ranger_msgs__msg__MotorState__rosidl_typesupport_introspection_c__MotorState_message_member_array[3] = {
  {
    "rpm",  // name
