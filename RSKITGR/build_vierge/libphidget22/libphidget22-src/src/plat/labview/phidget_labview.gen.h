...
typedef struct {
	int64 ch;
	double dutyCycle;
} lvPhidgetMotorVelocityControllerDutyCycleUpdateArgs;
...
} lvPhidgetMotorVelocityControllerExpectedVelocityChangeArgs;
...
typedef struct {
	int64 ch;
	double velocity;
} lvPhidgetMotorVelocityControllerVelocityChangeArgs;
