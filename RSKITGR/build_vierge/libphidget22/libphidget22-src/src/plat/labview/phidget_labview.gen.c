...
#ifdef COMPILE_PHIDGETS_LABVIEW
void CCONV PhidgetMotorVelocityController_OnDutyCycleUpdate_LaviewHandler(PhidgetMotorVelocityControllerHandle ch,void *ctx, double dutyCycle) {
	LVUserEventRef ev = *(LVUserEventRef *)ctx;
	MgErr ret = 0;
	lvPhidgetMotorVelocityControllerDutyCycleUpdateArgs *lvdata;
	lvdata = (lvPhidgetMotorVelocityControllerDutyCycleUpdateArgs *)DSNewPtr(sizeof(lvPhidgetMotorVelocityControllerDutyCycleUpdateArgs));
	lvdata->ch = (intptr_t)ch;
	lvdata->dutyCycle = dutyCycle;
	ret = PostLVUserEvent(ev, lvdata);
	DSDisposePtr(lvdata);
...
API_PRETURN_HDR PhidgetMotorVelocityController_setOnDutyCycleUpdateLabviewHandler(PhidgetMotorVelocityControllerHandle ch, LVUserEventRef *lvEventRef) {
	TESTPTR(ch);
	if(lvEventRef && *lvEventRef)
		PhidgetMotorVelocityController_setOnDutyCycleUpdateHandler(ch,
		  PhidgetMotorVelocityController_OnDutyCycleUpdate_LaviewHandler, lvEventRef);
	else
		PhidgetMotorVelocityController_setOnDutyCycleUpdateHandler(ch, NULL, NULL);
...
#ifdef COMPILE_PHIDGETS_LABVIEW
void CCONV PhidgetMotorVelocityController_OnExpectedVelocityChange_LaviewHandler(PhidgetMotorVelocityControllerHandle ch,void *ctx, double expectedVelocity) {
	LVUserEventRef ev = *(LVUserEventRef *)ctx;
	MgErr ret = 0;
	lvPhidgetMotorVelocityControllerExpectedVelocityChangeArgs *lvdata;
	lvdata = (lvPhidgetMotorVelocityControllerExpectedVelocityChangeArgs *)DSNewPtr(sizeof(lvPhidgetMotorVelocityControllerExpectedVelocityChangeArgs));
	lvdata->ch = (intptr_t)ch;
	lvdata->expectedVelocity = expectedVelocity;
	ret = PostLVUserEvent(ev, lvdata);
	DSDisposePtr(lvdata);
}

API_PRETURN_HDR PhidgetMotorVelocityController_setOnExpectedVelocityChangeLabviewHandler(PhidgetMotorVelocityControllerHandle ch, LVUserEventRef *lvEventRef) {
	TESTPTR(ch);
	if(lvEventRef && *lvEventRef)
		PhidgetMotorVelocityController_setOnExpectedVelocityChangeHandler(ch,
		  PhidgetMotorVelocityController_OnExpectedVelocityChange_LaviewHandler, lvEventRef);
	else
		PhidgetMotorVelocityController_setOnExpectedVelocityChangeHandler(ch, NULL, NULL);
...
#ifdef COMPILE_PHIDGETS_LABVIEW
void CCONV PhidgetMotorVelocityController_OnVelocityChange_LaviewHandler(PhidgetMotorVelocityControllerHandle ch,void *ctx, double velocity) {
	LVUserEventRef ev = *(LVUserEventRef *)ctx;
	MgErr ret = 0;
	lvPhidgetMotorVelocityControllerVelocityChangeArgs *lvdata;
	lvdata = (lvPhidgetMotorVelocityControllerVelocityChangeArgs *)DSNewPtr(sizeof(lvPhidgetMotorVelocityControllerVelocityChangeArgs));
	lvdata->ch = (intptr_t)ch;
	lvdata->velocity = velocity;
	ret = PostLVUserEvent(ev, lvdata);
	DSDisposePtr(lvdata);
...
API_PRETURN_HDR PhidgetMotorVelocityController_setOnVelocityChangeLabviewHandler(PhidgetMotorVelocityControllerHandle ch, LVUserEventRef *lvEventRef) {
	TESTPTR(ch);
	if(lvEventRef && *lvEventRef)
		PhidgetMotorVelocityController_setOnVelocityChangeHandler(ch,
		  PhidgetMotorVelocityController_OnVelocityChange_LaviewHandler, lvEventRef);
	else
		PhidgetMotorVelocityController_setOnVelocityChangeHandler(ch, NULL, NULL);
