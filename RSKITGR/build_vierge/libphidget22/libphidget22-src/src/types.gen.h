...
typedef enum {
	...
	PHIDID_FIRMWARE_UPGRADE_STM32F3 = 0x91,	/* VINT Device in firmware upgrade mode, STM32F3 Proc. */
	...
	PHIDID_HUB0002 = 0x93,	/* Phidget USB VINT Hub with 6 ports */
	PHIDID_HUB0004 = 0x43,	/* Phidget SPI VINT Hub with 6 ports */
	PHIDID_HUB0007 = 0x94,	/* Phidget USB VINT Hub with 1 port */
	...
	PHIDID_MOT0100 = 0x92,	/* Phidget Accelerometer */
	...
	PHIDID_RCC0004 = 0x7c,	/* PhidgetAdvancedServo 8-Motor */
	...
	PHIDID_STC1005 = 0x95,	/* 4A Bipolar Stepper Motor SmallController */
...
typedef enum {
	DECELERATION_TYPE_COAST = 0x1,	/* Coast */
	DECELERATION_TYPE_FORCED = 0x2,	/* Forced */
