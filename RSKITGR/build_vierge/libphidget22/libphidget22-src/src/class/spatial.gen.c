...
_setStatus(PhidgetChannelHandle phid, BridgePacket *bp) {
	...
	if (nsversion != 7) {
		loginfo("%"PRIphid": server/client class version mismatch: %d != 7 - functionality may be limited.", phid, nsversion);
	}
