...
PhidgetDictionary_add(PhidgetDictionaryHandle ch, const char *key, const char *value) {
	...
	return bridgeSendToDevice((PhidgetChannelHandle)ch, BP_DICTIONARYADD, NULL, NULL, 2, "%s%s", key,
	  value); 
}
...
PhidgetDictionary_removeAll(PhidgetDictionaryHandle ch) {
	...
	return bridgeSendToDevice((PhidgetChannelHandle)ch, BP_DICTIONARYREMOVEALL, NULL, NULL, 0, NULL); 
}
...
PhidgetDictionary_remove(PhidgetDictionaryHandle ch, const char *key) {
	...
	return bridgeSendToDevice((PhidgetChannelHandle)ch, BP_DICTIONARYREMOVE, NULL, NULL, 1, "%s",
	  key); 
}
...
PhidgetDictionary_set(PhidgetDictionaryHandle ch, const char *key, const char *value) {
	...
	return bridgeSendToDevice((PhidgetChannelHandle)ch, BP_DICTIONARYSET, NULL, NULL, 2, "%s%s", key,
	  value); 
}
...
PhidgetDictionary_update(PhidgetDictionaryHandle ch, const char *key, const char *value) {
	...
	return bridgeSendToDevice((PhidgetChannelHandle)ch, BP_DICTIONARYUPDATE, NULL, NULL, 2, "%s%s", key,
	  value); 
}
