...
PhidgetRCServo_setTargetPosition(PhidgetRCServoHandle ch, double targetPosition) {
	...
	return (bridgeSendToDevice((PhidgetChannelHandle)ch, BP_SETTARGETPOSITION, NULL, NULL, 1, "%g",
...
PhidgetRCServo_setTargetPosition_async(PhidgetRCServoHandle ch, double targetPosition, Phidget_AsyncCallback fptr,
	...
	res = bridgeSendToDevice((PhidgetChannelHandle)ch, BP_SETTARGETPOSITION, fptr, ctx, 1, "%g", POSITION_US(targetPosition));
...
PhidgetRCServo_setVelocityLimit(PhidgetRCServoHandle ch, double velocityLimit) {
	...
	return (bridgeSendToDevice((PhidgetChannelHandle)ch, BP_SETVELOCITYLIMIT, NULL, NULL, 1, "%g",
