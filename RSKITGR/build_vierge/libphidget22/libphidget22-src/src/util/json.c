...
int parseJSON(const char *json, uint32_t jsonlen, char *allocbuf, size_t allocbufsz, const char *fmt, ...) {
	va_list va;
	int res;
...
int mkJSON(char *json, uint32_t jsonlen, const char *fmt, ...) {
	va_list va;
	int res;
...
int mkJSONv(char *json, uint32_t jsonlen, const char *fmt, va_list va) {
...
int parseJSONv(const char *json, uint32_t jsonlen, char *allocbuf, size_t allocbufsz,
