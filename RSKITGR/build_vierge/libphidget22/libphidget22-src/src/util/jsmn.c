...
int pjsmn_boolean(const char *jsonsrc, pjsmntok_t *tok) {
...
int pjsmn_uint64(const char *jsonsrc, pjsmntok_t *tok, uint64_t *ret) {
	char buf[32];
	size_t n;
	int err;
...
int pjsmn_int64(const char *jsonsrc, pjsmntok_t *tok, int64_t *ret) {
	char buf[32];
	size_t n;
	int err;
...
int pjsmn_double(const char *jsonsrc, pjsmntok_t *tok, double *ret) {
	char buf[64];
	size_t n;
	char *end;
