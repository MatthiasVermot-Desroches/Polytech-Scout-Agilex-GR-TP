...
Phidget_enumFromString(const char *name) {
	...
	if (mos_strcasecmp(name, "EPHIDGET_BADPOWER") == 0)
		return (62);

	if (mos_strcasecmp(name, "EPHIDGET_POWERCYCLE") == 0)
		return (63);

	if (mos_strcasecmp(name, "EPHIDGET_HALLSENSOR") == 0)
		return (64);

	if (mos_strcasecmp(name, "EPHIDGET_BADCURRENT") == 0)
		return (65);
	...
	if (mos_strcasecmp(name, "EEPHIDGET_FAULT") == 0)
		return (4116);

	if (mos_strcasecmp(name, "EEPHIDGET_ESTOP") == 0)
		return (4117);
	...
	if (mos_strcasecmp(name, "PHIDID_ENC1001") == 0)
		return (155);
	...
	if (mos_strcasecmp(name, "PHIDID_FIRMWARE_UPGRADE_STM32F3") == 0)
		return (145);
	...
	if (mos_strcasecmp(name, "PHIDID_HUB0007") == 0)
		return (148);
	...
	if (mos_strcasecmp(name, "PHIDID_MOT0100") == 0)
		return (146);
	...
	if (mos_strcasecmp(name, "PHIDID_STC1005") == 0)
		return (149);
	...
	if (mos_strcasecmp(name, "PHIDCHCLASS_MOTORVELOCITYCONTROLLER") == 0)
		return (39);
	...
	if (mos_strcasecmp(name, "DECELERATION_TYPE_COAST") == 0)
		return (1);

	if (mos_strcasecmp(name, "DECELERATION_TYPE_FORCED") == 0)
		return (2);

	if (mos_strcasecmp(name, "POSITION_TYPE_ENCODER") == 0)
		return (1);

	if (mos_strcasecmp(name, "POSITION_TYPE_HALL_SENSOR") == 0)
		return (2);
...
Phidget_enumString(const char *family, int id) {
	...
	if (mos_strcasecmp(family, "DecelerationType") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "PositionType") == 0) {
		switch (id) {
		case 1:
...
supportedDeviceID(PhidgetChannelHandle ch, Phidget_DeviceID val) {
	...
	case PHIDCHUID_MOT0110_ACCELEROMETER_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0110:
			return (1);
	...
	case PHIDCHUID_MOT0110_GYROSCOPE_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0110:
			return (1);
	...
	case PHIDCHUID_MOT0110_MAGNETOMETER_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0110:
			return (1);
	...
	case PHIDCHUID_STM32F3_FIRMWARE_UPGRADE_120:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_FIRMWARE_UPGRADE_STM32F3:
			return (1);
		default:
			return (0);
		}
...
int
supportedDecelerationType(PhidgetChannelHandle ch, Phidget_DecelerationType val) {
...
int
supportedPositionType(PhidgetChannelHandle ch, Phidget_PositionType val) {
