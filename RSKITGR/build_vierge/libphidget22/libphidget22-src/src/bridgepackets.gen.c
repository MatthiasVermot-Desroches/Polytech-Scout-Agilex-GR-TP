...
bridgepacketinfo_t bridgepacketinfo[] = {
	...
	{ "BP_SETCALIBRATIONVALUES2", BP_FLAG_NOFORWARD}, /* 0xb2 */
	{ "BP_HEATINGENABLEDCHANGE", 0}, /* 0xb3 */
	{ "BP_RTDWIRESETUPCHANGE", 0}, /* 0xb4 */
	{ "BP_POWERSUPPLYCHANGE", 0}, /* 0xb5 */
	{ "BP_INPUTMODECHANGE", 0}, /* 0xb6 */
	{ "BP_SETPORTAUTOSETSPEED", BP_FLAG_NOFORWARD}, /* 0xb7 */
	{ "BP_SETINDUCTANCE", 0}, /* 0xb8 */
	{ "BP_INDUCTANCECHANGE", 0}, /* 0xb9 */
	{ "BP_DECELERATIONTYPE", 0}, /* 0xba */
	{ "BP_POSITIONTYPE", 0}, /* 0xbb */
	{ "BP_EXPECTEDPOSITIONCHANGE", 0}, /* 0xbc */
	{ "BP_SETENABLEEXPECTEDPOSITION", 0}, /* 0xbd */
	{ "BP_EXPECTEDVELOCITYCHANGE", 0}, /* 0xbe */
	{ "BP_SETENABLEEXPECTEDVELOCITY", 0}, /* 0xbf */
	{ "BP_SETFAILSAFECURRENTLIMIT", 0}, /* 0xc0 */
	{ "BP_SETFAILSAFEBRAKINGDUTYCYCLE", 0}, /* 0xc1 */
	{ "BP_SETSURGECURRENTLIMIT", 0}, /* 0xc2 */
	{ "BP_SURGECURRENTLIMITCHANGE", 0}, /* 0xc3 */
	{ "BP_CURRENTLIMITCHANGE", 0}, /* 0xc4 */
	{ "BP_ACTIVECURRENTLIMITCHANGE", 0}, /* 0xc5 */
	{ (void *)0, 0 }
};
