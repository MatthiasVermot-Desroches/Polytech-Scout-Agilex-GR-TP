...
: ${AMENT_CURRENT_PREFIX:="/home/user/roskit_ws/install/gr_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gr_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gr_bringup/environment/path.sh"
